    ...
    const { Wrap, config } = BF_Wrap2({
        default_conf: {
            ...
            searchConfig: defineFormConfig([
                ...
                { label: '上报状态', name: 'womanUploadState', inputType: 'MS', inputProps: { optionKey: '上报状态' } },
            ]),
            tableColumns: defineFormConfig([
                ...
                { title: '上报状态', dataIndex: 'womanUploadState', inputType: 'MS', inputProps: { optionKey: '上报状态', marshal: 0 } },
                ...
                { title: '男方上报状态', dataIndex: 'manUploadState', inputType: 'MS', inputProps: { optionKey: '上报状态', marshal: 0 } },
